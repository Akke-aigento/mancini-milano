...
const SplashScreen = () => {
  ...
  return (
    <div
      className="fixed inset-0 z-[100] bg-background flex items-center justify-center transition-opacity duration-500 ease-out"
    ...
    >
      ...
      <img
        src={logoDoberman}
        alt="Mancini Milano"
        className="h-32 md:h-48 w-auto transition-transform duration-500 ease-out"
        style={{
