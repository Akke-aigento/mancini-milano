      ...
      <Layout>
        <div className="max-w-site mx-auto px-4 lg:px-8 py-12">
          <div className="grid grid-cols-1 lg:grid-cols-[1.2fr_1fr] gap-8 lg:gap-12">
            <div className="aspect-[3/4] bg-background animate-pulse" />
            <div className="space-y-4">
              <div className="h-4 bg-background w-1/2 animate-pulse" />
              <div className="h-8 bg-background w-3/4 animate-pulse" />
              <div className="h-6 bg-background w-1/4 animate-pulse" />
            </div>
          </div>
        </div>
      </Layout>
