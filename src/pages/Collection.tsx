                ...
                <div className="relative aspect-[3/4] overflow-hidden mb-3">
                  {cat.image ? (
                    <img
                      ...
                      alt={cat.label}
                      loading="lazy"
                      className="absolute inset-0 w-full h-full className="absolute inset-0 w-full h-full object-contain group-hover:scale-105 transition-transform duration-700" transition-transform duration-700"
                    />
                  ) : (
