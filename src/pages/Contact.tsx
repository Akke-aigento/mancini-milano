          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="space-y-3">
                ...
                <a href="https://instagram.com/mancinimilano" target="_blank" rel="noopener noreferrer" className="flex items-center gap-3 text-sm text-muted-foreground hover:text-foreground transition-colors">
